...
| i18n Migration to Composition API | 🔄 In Progress | Continued migration (12/28 components done) |
...
3. Continue the i18n migration to the Composition API (12/28 components migrated)
   - Completed: 
     - Views: DriveAccess.vue, ThreatModelSelect.vue, BranchAccess.vue, RepositoryAccess.vue, ToSPage.vue, PrivacyPage.vue
     - Components: SelectionPage.vue, AddBranchDialog.vue, ConfirmationModal.vue, GraphThreats.vue, TdFormTextareaWrapper.vue, ReadOnlyDiagram.vue
