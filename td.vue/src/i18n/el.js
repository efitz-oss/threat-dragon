const ell = {
    ...
    providers: {
        ...
        googleDrive: {
            ...
            loginWith: 'Άνοιγμα',
            description:
                'Επιλέξτε ένα αρχείο μοντέλου απειλών ή φάκελο προορισμού από το Google Drive',
            saveThreatModel: 'Αποθήκευση μοντέλου απειλών στο Google Drive',
            saveDescription:
                'Επιλέξτε ένα φάκελο στο Google Drive για να αποθηκεύσετε το μοντέλο απειλών σας',
    ...
    threatmodel: {
        ...
        errors: {
            ...
            googleDriveSave:
                'Σφάλμα κατά την αποθήκευση στο Google Drive. Βεβαιωθείτε ότι έχετε τα κατάλληλα δικαιώματα.'
        },
