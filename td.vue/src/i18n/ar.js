const ara = {
    ...
    tos: {
        ...
        contact: 'إذا كانت لديك أي أسئلة حول هذه الشروط، فلا تتردد في الاتصال بفريق الدعم.'
    },
    privacy: {
        ...
        sections: [
            ...
            {
                heading: 'اتصل بنا',
                content: 'إذا كانت لديك أي أسئلة حول سياسة الخصوصية هذه، فلا تتردد في الاتصال بفريق الدعم.'
            }
        ]
    },
    nav: {
