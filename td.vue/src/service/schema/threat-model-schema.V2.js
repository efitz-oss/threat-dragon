                                    ...
                                    properties: {
                                        ...
                                        data: {
                                            ...
                                            properties: {
                                                ...
                                                isEncrypted: {
                                                    description:
                                                        'The data-flow flag set if is bidirectional',
                                                    type: 'boolean',
                                                },
                                                isPublicNetwork: {
                                                    description:
                                                        'The data-flow flag set if it crosses a public network',
                                                    type: 'boolean',
                                                },
                                                isSigned: {
                                                    description:
                                                ...
                                                providesAuthentication: {
                                                    description:
                                                        'The component flag set if the Actor provides Authentication',
                                                    type: 'boolean',
                                                },
                                                reasonOutOfScope: {
                                                    description:
                                        ...
                                        source: {
                                            ...
                                            properties: {
                                                cell: {
                                                    description:
                                                        'The data-flow source attachment point',
                                                    type: 'string',
                                                },
                                                x: {
                                                    description:
                                        ...
                                        target: {
                                            ...
                                            properties: {
                                                cell: {
                                                    description:
                                                        'The data-flow target attachment point',
                                                    type: 'string',
                                                },
                                                x: {
                                                    description:
