            ...
            <b-form-row>
                <b-col md="6">
                    <b-form-group id="name-group" label-cols="auto" :label="cellRef.data && cellRef.data.type === 'tm.Text'
                        ...
                        " label-for="name">
                        <b-form-textarea id="name" v-model="cellRef.data.name"
                            :rows="cellRef.data.type === 'tm.Text' ? 7 : 2" graph-pro @update="onChangeName()" />
                    </b-form-group>
                </b-col>
                ...
                <b-col v-if="cellRef.data.type !== 'tm.Text'" md="6">
                    <b-form-group id="description-group" label-cols="auto"
                        ...
                        <b-form-textarea id="description" v-model="cellRef.data.description"
                ...
                <b-col v-if="!cellRef.data.isTrustBoundary && cellRef.data.type !== 'tm.Text'" md="6">
                    <b-form-group id="reasonoutofscope-group" label-cols="auto"
                        ...
                        <b-form-textarea id="reasonoutofscope" v-model="cellRef.data.reasonOutOfScope"
                            :disabled="!cellRef.data.outOfScope" @change="onChangeProperties()" />
                    </b-form-group>
                </b-col>
