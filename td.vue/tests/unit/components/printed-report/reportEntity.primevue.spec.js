...
import TdReportEntity from '@/components/printed-report/ReportEntity.primevue.vue';
...
describe('components/printed-report/ReportEntity.primevue.vue', () => {
    ...
    describe('basic component rendering', () => {
        ...
        it('renders a PrimeVue styled table', () => {
            expect(wrapper.find('.p-table').exists()).toBe(true);
        });
    });
